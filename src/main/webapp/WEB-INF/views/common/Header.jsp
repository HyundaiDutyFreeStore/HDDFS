...
<script
   src="https://connect.facebook.net/ko_KR/sdk.js?hash=6bbb0c765ded76ecc1c42c72e5b6ad30"
   async="" crossorigin="anonymous"></script>
<script id="facebook-jssdk"
   src="//connect.facebook.net/ko_KR/sdk.js#xfbml=1&amp;version=v2.10&amp;appId=338912136590462"></script>
<script type="text/javascript" async=""
   src="https://www.google-analytics.com/analytics.js"></script>
<script async=""
...
<script
   src="//rum.beusable.net/load/b220906e090106u517?url=https%3A%2F%2Fwww.hddfs.com%2Fshop%2Fmm%2FmbshJoin%2Fjoin.do"
...
<script>
   ...
   function fnUmbJoinPop(joinType, ptnrChlCd, ptcoAlliPaonInf2) {
      ...
      $form
            .append('<input type="hidden" value="' + joinType + '" name="ptcoReqnOnoflnGb">');
      $form
            .append('<input type="hidden" value="' + ptnrChlCd + '" name="ptcoAlliPaonInf1">');
      $form
            .append('<input type="hidden" value="' + ptcoAlliPaonInf2 + '" name="ptcoAlliPaonInf2">');
      $form.appendTo('body');
...
<script src="//script.beusable.net/ba.v1.0.0.min.js" async=""
   type="text/javascript"></script>
<style type="text/css"
...
<link rel="stylesheet" type="text/css"
   href="//static.groobee.io/dist/g2/css/custom-jquery-ui.css">
<link rel="stylesheet" type="text/css"
...
<script>
   ...
   $(function() {
      ...
      // 이지웰 로그인 팝업
      if (!isLogin && getCookie("closePopEz") != "Y"
            && getCookie("PTNR_CHL_GBN_KEY") == "00009902"
            && getCookie("EZWEL_USER_KEY_SESSION") != null
            && location.href.indexOf("membershipSleepRelease") == -1) {
         if (location.href.indexOf("main") == -1) { // 메인이 아닐때 팝업 뜸
            $(".main_popup2").css("display", "block");
            $(".main_popup2").dialog("open");
         } else if (location.href.indexOf("main") != -1
               && sessionStorage.getItem("selMainSwiperPos") != 0) {//메인인 경우 인트로 아닐때 팝업뜸
            $(".main_popup2").css("display", "block");
            $(".main_popup2").dialog("open");
         }
      }
      ...
      $(".intro_box")
            .scroll(
                  function() {
                     if (!isLogin
                           && getCookie("closePopEz") != "Y"
                           && getCookie("PTNR_CHL_GBN_KEY") == "00009902"
                           && getCookie("EZWEL_USER_KEY_SESSION") != null
                           && location.href
                                 .indexOf("membershipSleepRelease") == -1
                           && sessionStorage
                                 .getItem("selMainSwiperPos") != 0) {
                        $(".main_popup2").css("display", "block");
                        $(".main_popup2").dialog("open");
                     }
                  });
         ...
         <section class="box">
            ...
            <script type="text/javascript">
               $(function() {
                  ...
                  // 검색창 클릭시 검색 레이어 호출
                  $("#basicSearchTerm, #hashSearchTerm")
                        .on(
                              'click',
                              function() {
               ...
               function branAction(branCd) {
                  $(location).attr(
                        'href',
                        ctx_curr + "/dm/bran/brand.do?onlnBranCd="
                              + branCd);
               ...
               function searchHeaderAction() {
                  ...
                  if (!$(".mainsearchinput").hasClass('tag')) {
                     if ($("#basicSearchTerm").val() === "") {
                        ...
                        result = checkSearchTerm($("#basicSearchTerm")
                              .val());
                     ...
                     if ($("#hashSearchTerm").val() === "") {
                        ...
                        result = checkSearchTerm($("#hashSearchTerm")
                              .val());
               ...
               function commOpenLayer(cookieChkYn, hiddenYn) {
                  $
                        .ajax({
                           ...
                           dataType : "json",
                           type : "POST",
                           success : function(popInfo, textStatus,
                                 jqXHR) {
               ...
               function issueHiddenCoupon(cupId) {
                  ...
                  issueCoupon(cupId, function(data) {
                     if (data.resultCode == 1) {
                        alert('쿠폰이 다운로드 되었습니다.'); /*쿠폰이 다운로드 되었습니다<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="format-detection" content="telephone=no">
<meta name="title" content="현대백화점인터넷면세점">
<meta name="description"
	content="해외명품/화장품/시계/가방, 적립금/할인/쿠폰 등 다양한 혜택, 공동구매/가상착장(AR)서비스 제공">
