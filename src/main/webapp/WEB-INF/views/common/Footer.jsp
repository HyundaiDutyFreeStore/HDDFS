...
<footer id="footer">
	<div class="policy">
		<div class="box">
			<div class="policy_menu">
				<a href="https://www.hddfs.com/store/kr/dm/main.do" target="_blank">현대백화점
					DUTY FREE 소개</a> <a
	...
	<div class="copy">
		<div class="copyright">
			...
			<ul>
				<li><span>대표이사 : 이재실</span> <span>서울특별시 강남구 영동대로82길 19</span> <span>사업자등록번호
						: 850-88-00325</span></li>
				<li><a
			...
			<p>COPYRIGHT © HYUNDAI DEPARTMENT STORE DUTY FREE. ALL RIGHTS
				RESERVED.</p>
			<div class="sns_link">
				<a href="https://www.facebook.com/HDDFS.official/" target="_blank"
		...
		<div class="escrow">
			<strong>주식회사 케이에스넷 구매안전(에스크로) 서비스 가맹점</strong> <span> 안전한
				전자상거래를 위해 ㈜ 케이에스넷의 구매안전(에스크로) 서비스에 <br> 가입하여, 구매안전(에스크로) 서비스를
				제공하고 있습니다.
			</span>
			...
			<div class="list_prize">
				<ul>
					<li class="ismsp">인증범위 : 현대백화점면세점 면세점 서비스 운영<br>유효기간 :
						2022.11.27~2025.11.26
					</li>
					<li class="award"><a
					...
					<!--//award-->
					<li class="first"><a
						href="https://fba.kcforum.co.kr/2023/winner.php" target="_blank">2023
							대한민국 퍼스트브랜드 대상 <br>면세점 부문 2년 연속 1위
					</a></li>
					<!--//first-->
				</ul>
			</div>
...
<script type="text/javascript">
	var userLgcpBuyMbsh = "001";
	var userLgcpBuyMbshDtl = "";
	var userMbshNo = "";
	var htmlGuideUseYn = "";
	...
	$("meta[property='groobee:member_id']").attr("content", "");
	$("meta[property='groobee:member_grade']").attr("content", "");
	$("meta[property='groobee:member_gender']").attr("content", "");
</script>
