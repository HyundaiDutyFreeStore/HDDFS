<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
		...
		<main id="container"> <script type="text/javascript">
                ...
                $(document)
                    .ready(
                        function () {
                                            ...
                                            if (target == "01") { //대상그룹
                                                ...
                                                if ($(
                                                    ...
                                                    if ($(
                                                        ...
                                                        $(this)
                                                            .remove(); // 대상 그룹이 아니며, 대상회원도 아닌 경우 삭제	 	
                                                        return true;
                                                    }
                                                } else {
                                                    if ($(
                            ...
                            $("#basicSearchTermIntro, #hashSearchTermIntro")
                                .on('click', function () {
                                    srchLayerIntro();
                                });
                            ...
                            if (chkHastagSeq != null) {
                                ...
                                $(".hyundaiStyleHashtag > section")
                                    .removeClass("open");
                                $(".hyundaiStyleHashtag > section").first()
                                    .find(".tab-action").hide();
                                $(
                    ...
                    if ("N" == "Y") {
                        ...
                        $.each($(".goosList"), function (i, el) {
                            ...
                            if ($(this).attr("data-adult") == "Y") {
                                ...
                                $(this).find('a').attr(
                                    "href",
                                    ctx_shop + "/gd/dtl/goos.do?onlnGoosCd=" +
                                    goosCd);
                                $(this).find('.cartBtn').attr(
                                    "onclick",
                                    'newAddCartMulti("' + goosCd + '", "' +
                                    minBuyQty +
                                    '", "", "", "order","N",event)');
                ...
                function changeMainStyle(type) {
                    ...
                    if (type == 'hdstyle') {
                        ...
                        $(".hyundaiStyleHashtag > section").first().find(".tab-action")
                            .hide();
                        $(".hyundaiStyleHashtag > section > .tab-action").first()
                ...
                function moreHashtagItems(obj, hashtagSeq, hashSeq, dispAltiClsCd,
                    optionCd) {
                    $.ajax({
                        async: true,
                ...
                function searchIntroAction() {
                    ...
                    if (!$(".introsearcharea").hasClass('taginput')) {
                        ...
                        if ($("#hashSearchTermIntro").val() === "") {
                            ...
                            searchHeaderIntro.action = ctx_curr +
		...
		<script type="text/javascript">
                ...
                $("#hpAuth").click(
                    function () {
                        ...
                        openDRMOKWindow(type, goodsCd, qty, buynow, setGoosId,
                            cartSeq, cartSetId, notAdtGoodsCd, notAdtQtyList);
                    });
                ...
                /* 성인인증 팝업 */
                function openPopup(obj, type, goodsCd, qtyList, setGoosId, buyNow,
                    cartSeq, cartSetId, notAdtGoodsCd, notAdtQtyList) {
                ...
                function adultPopup(type, goodsCd, qtyList, buyNow, setGoosId, cartSeq,
                    ...
                    $("#chkBtn").closest('li').next().next().next().attr("value",
                        buyNow);
                ...
                function adultAuthPop(obj) {
                    ...
                    var buyNow = $(obj).closest("li").next().next().next()
                        .attr("value");
                ...
                function openDRMOKWindow(type, goodsCd, qty, buynow, setGoosId,
                    cartSeq, cartSetId, notAdtGoodsCd, notAdtQtyList) {
            ...
            </script> <input type="hidden" id="introType" value="S" /> <input
			type="hidden" id="lgcpBuyMbshGrpCd" value="001" />
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide" style="background: black;">
						<video
							...
							preload="none" loop muted autoplay="true"
			...
			<div class="hyundaiStyleHashtag">
				<section class="hashtag hStyleGroup">
					...
					<div class="tab-action">
						...
						<div class="hashtagDtlInfo4013398" id="H4013398_001"
							class="show401"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_002"
							class="show401" style="display: none;"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_003"
							class="show401" style="display: none;"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_004"
							class="show401" style="display: none;">
						...
						<div class="hashtagDtlInfo4013398" id="H4013398_005"
							class="show401" style="display: none;"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_006"
							class="show401" style="display: none;"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_007"
							class="show401" style="display: none;">
							<div class="pro_banner">
						...
						<div class="hashtagDtlInfo4013398" id="H4013398_008"
							class="show401" style="display: none;">
							<div class="pro_banner">
								<div class="product_module coupon hashtagCupList4013398"></div>
							</div>
						</div>
						<div class="hashtagDtlInfo4013398" id="H4013398_009"
							class="show401" style="display: none;"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_010"
							class="show401" style="display: none;"></div>
						<div class="hashtagDtlInfo4013398" id="H4013398_011"
							class="show401" style="display: none;"></div>
					</div>
				</section>
				<section class="hashtag hStyleGroup">
					...
					<div class="tab-action">
						...
						<div class="hashtagDtlInfo4944421" id="H4944421_001"
							class="show494">
						...
						<div class="hashtagDtlInfo4944421" id="H4944421_002"
							class="show494" style="display: none;">
							<div class="pro_banner">
						...
						<div class="hashtagDtlInfo4944421" id="H4944421_003"
							class="show494" style="display: none;"></div>
						<div class="hashtagDtlInfo4944421" id="H4944421_004"
							class="show494" style="display: none;"></div>
						<div class="hashtagDtlInfo4944421" id="H4944421_005"
							class="show494" style="display: none;"></div>
						<div class="hashtagDtlInfo4944421" id="H4944421_006"
							class="show494" style="display: none;"></div>
						<div class="hashtagDtlInfo4944421" id="H4944421_007"
							class="show494" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box text_banner product_module">
									<div class="product-module-swiper">
						...
						<div class="hashtagDtlInfo4944421" id="H4944421_008"
							class="show494" style="display: none;">
							<div class="pro_banner">
								<div class="product_module coupon hashtagCupList4944421"></div>
							</div>
						</div>
						<div class="hashtagDtlInfo4944421" id="H4944421_009"
							class="show494" style="display: none;"></div>
						<div class="hashtagDtlInfo4944421" id="H4944421_010"
							class="show494" style="display: none;"></div>
						<div class="hashtagDtlInfo4944421" id="H4944421_011"
							class="show494" style="display: none;"></div>
					</div>
				</section>
				<section class="hashtag hStyleGroup">
					...
					<div class="tab-action">
						...
						<div class="hashtagDtlInfo5044550" id="H5044550_001"
							class="show504">
									...
									<li data-gooscd="10257250016401" data-minbuyqty="1"
										...
										href="https://www.hddfs.com/shop/gd/dtl/goos.do?onlnGoosCd=10257250016401&MG=KR_PC_Main_Hashtag504_Product_10257250016401">
											...
											<div class="pro_i">
												...
												<p class="tx_ex goosNm">새해 한정판 드라마티컬리 디퍼런트 모이스춰라이징 젤
													125ml</p>
												<p class="price1" style="height: 19px;">
													<del>$37</del>
													<strong>30%</strong>
						...
						<div class="hashtagDtlInfo5044550" id="H5044550_002"
							class="show504" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box module_circle product_module">
									<div class="product-module-swiper">
										<div class="swiper-wrapper">
						...
						<div class="hashtagDtlInfo5044550" id="H5044550_003"
							class="show504" style="display: none;"></div>
						<div class="hashtagDtlInfo5044550" id="H5044550_004"
							class="show504" style="display: none;"></div>
						<div class="hashtagDtlInfo5044550" id="H5044550_005"
							class="show504" style="display: none;"></div>
						<div class="hashtagDtlInfo5044550" id="H5044550_006"
							class="show504" style="display: none;"></div>
						<div class="hashtagDtlInfo5044550" id="H5044550_007"
							class="show504" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box text_banner product_module">
									<div class="product-module-swiper">
						...
						<div class="hashtagDtlInfo5044550" id="H5044550_008"
							class="show504" style="display: none;">
							<div class="pro_banner">
								<div class="product_module coupon hashtagCupList5044550"></div>
							</div>
						</div>
						<div class="hashtagDtlInfo5044550" id="H5044550_009"
							class="show504" style="display: none;"></div>
						<div class="hashtagDtlInfo5044550" id="H5044550_010"
							class="show504" style="display: none;"></div>
						<div class="hashtagDtlInfo5044550" id="H5044550_011"
							class="show504" style="display: none;"></div>
					</div>
				</section>
				<section class="hashtag hStyleGroup">
					...
					<div class="tab-action">
						...
						<div class="hashtagDtlInfo3522506" id="H3522506_001"
							class="show352">
						...
						<div class="hashtagDtlInfo3522506" id="H3522506_002"
							class="show352" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box module_circle product_module">
									<div class="product-module-swiper">
										<div class="swiper-wrapper">
						...
						<div class="hashtagDtlInfo3522506" id="H3522506_003"
							class="show352" style="display: none;"></div>
						<div class="hashtagDtlInfo3522506" id="H3522506_004"
							class="show352" style="display: none;"></div>
						<div class="hashtagDtlInfo3522506" id="H3522506_005"
							class="show352" style="display: none;"></div>
						<div class="hashtagDtlInfo3522506" id="H3522506_006"
							class="show352" style="display: none;"></div>
						<div class="hashtagDtlInfo3522506" id="H3522506_007"
							class="show352" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box text_banner product_module">
									<div class="product-module-swiper">
						...
						<div class="hashtagDtlInfo3522506" id="H3522506_008"
							class="show352" style="display: none;">
							<div class="pro_banner">
								<div class="product_module coupon hashtagCupList3522506"></div>
							</div>
						</div>
						<div class="hashtagDtlInfo3522506" id="H3522506_009"
							class="show352" style="display: none;"></div>
						<div class="hashtagDtlInfo3522506" id="H3522506_010"
							class="show352" style="display: none;"></div>
						<div class="hashtagDtlInfo3522506" id="H3522506_011"
							class="show352" style="display: none;"></div>
					</div>
				</section>
				<section class="hashtag hStyleGroup">
					...
					<div class="tab-action">
						...
						<div class="hashtagDtlInfo4393927" id="H4393927_001"
							class="show439">
						...
						<div class="hashtagDtlInfo4393927" id="H4393927_002"
							class="show439" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box module_circle product_module">
									<div class="product-module-swiper">
										<div class="swiper-wrapper">
						...
						<div class="hashtagDtlInfo4393927" id="H4393927_003"
							class="show439" style="display: none;"></div>
						<div class="hashtagDtlInfo4393927" id="H4393927_004"
							class="show439" style="display: none;"></div>
						<div class="hashtagDtlInfo4393927" id="H4393927_005"
							class="show439" style="display: none;"></div>
						<div class="hashtagDtlInfo4393927" id="H4393927_006"
							class="show439" style="display: none;"></div>
						<div class="hashtagDtlInfo4393927" id="H4393927_007"
							class="show439" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box text_banner product_module">
									<div class="product-module-swiper">
						...
						<div class="hashtagDtlInfo4393927" id="H4393927_008"
							class="show439" style="display: none;">
							<div class="pro_banner">
								<div class="product_module coupon hashtagCupList4393927"></div>
							</div>
						</div>
						<div class="hashtagDtlInfo4393927" id="H4393927_009"
							class="show439" style="display: none;"></div>
						<div class="hashtagDtlInfo4393927" id="H4393927_010"
							class="show439" style="display: none;"></div>
						<div class="hashtagDtlInfo4393927" id="H4393927_011"
							class="show439" style="display: none;"></div>
					</div>
				</section>
				<section class="hashtag hStyleGroup">
					...
					<div class="tab-action">
						...
						<div class="hashtagDtlInfo4424032" id="H4424032_001"
							class="show442">
						...
						<div class="hashtagDtlInfo4424032" id="H4424032_002"
							class="show442" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box module_circle product_module">
									<div class="product-module-swiper">
										<div class="swiper-wrapper">
						...
						<div class="hashtagDtlInfo4424032" id="H4424032_003"
							class="show442" style="display: none;"></div>
						<div class="hashtagDtlInfo4424032" id="H4424032_004"
							class="show442" style="display: none;"></div>
						<div class="hashtagDtlInfo4424032" id="H4424032_005"
							class="show442" style="display: none;"></div>
						<div class="hashtagDtlInfo4424032" id="H4424032_006"
							class="show442" style="display: none;"></div>
						<div class="hashtagDtlInfo4424032" id="H4424032_007"
							class="show442" style="display: none;">
							<div class="pro_banner">
								<div class="swiper_box text_banner product_module">
									<div class="product-module-swiper">
						...
						<div class="hashtagDtlInfo4424032" id="H4424032_008"
							class="show442" style="display: none;">
							<div class="pro_banner">
								<div class="product_module coupon hashtagCupList4424032"></div>
							</div>
						</div>
						<div class="hashtagDtlInfo4424032" id="H4424032_009"
							class="show442" style="display: none;"></div>
						<div class="hashtagDtlInfo4424032" id="H4424032_010"
							class="show442" style="display: none;"></div>
						<div class="hashtagDtlInfo4424032" id="H4424032_011"
							class="show442" style="display: none;"></div>
					</div>
				</section>
			</div>
