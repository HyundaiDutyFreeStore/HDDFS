		...
		<div class="sub_container">
			...
			<div class="sub_cnts">
				<form id="updateMember" method="post">
					 <input type="hidden"
						id="emailAddress" name="emailAddress" value=""> <input
						type="hidden" id="sBirthday" name="sBirthday" value="">
					...
					<div>
							...
							<div class="tblwrap">
                                ...
                                <td>
                                    ...
                                    <span class="guide_comment" id="emailMsg"></span>
                                     ...
                                     <input id="memail" name="memail" style="display:none;"value="${member.memail}">
										...
										<tr>
											...
											<td><input type="text" style="width: 120px" id="mtel"
												name="mtel" value="${member.mtel}"><font id="telCheckSpan"></font>
										</tr>
						...
						<!-- btn_btwrap -->
							...
							<button class="deleteBtn" id="deleteBtn">회원탈퇴</button>
						
						<div class="btnwrap mypage2">
							<input type="button" class="btn wt" value="회원탈퇴" id="deleteBtn" onclick="location.href='/member/mypage'">
							<input type="button" class="btn wt" value="취소" id="cancleBtn" onclick="location.href='/member/mypage'">
							<input type="button" class="update_button" value="변경사항 저장"
								id="update_button">
						</div>
						<!-- //btn_btwrap -->
					</div>
