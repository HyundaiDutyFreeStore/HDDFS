...
<script type="text/javascript">
	$(document).ready(function () {
		$("#agrYnsAll").click(function () {
			if ($("#agrYnsAll").is(":checked"))
				$("input[name=agrYns]").prop("checked", true);
			else
				$("input[name=agrYns]").prop("checked", false);
		});
		$("input[name=agrYns]").click(function () {
			var total = $("input[name=agrYns]").length;
			var checked = $("input[name=agrYns]:checked").length;

			if (total != checked)
				$("#agrYnsAll").prop("checked", false);
			else
				$("#agrYnsAll").prop("checked", true);
		});
	});

	function checkrequired() {
		if ($('#agree1').is(":checked") == false) {
			alert("이용약관동의는 필수 항목 입니다.")
			event.preventDefault();
		} else if ($('#agree2').is(":checked") == false) {
			alert("개인정보동의는 필수 항목입니다.")
			event.preventDefault();
		}
	...
	<div class="container">
		<section>
			...
			<!-- 	<form id="frmTermsAgree" name="frmTermsAgree" method="post"> -->
					...
					<p class="all_agree">
						<span class="checkbox round"> <input type="checkbox" name="agrYnsAll" id="agrYnsAll"> <label
								for="agrYnsAll">
								모두동의</label>
						</span>
					</p>
					...
					<p class="step_agree">
						<span class="checkbox round"> <input type="checkbox" name="agrYns" id="agree1" value="Y"> <label
								for="agree1" value="이용약관동의"> 이용약관동의<span> (필수)</span>
							</label>
						</span>
					</p>
						...
						<ul class="terms_style">
							<li><span id="terms01">제 1 조 (목적) </span>
								<p class="terms_txt">본 약관은 ㈜현대백화점면세점이 운영하는 현대백화점 면세점 온라인 쇼핑몰
									...
									인터넷면세점 이용자의 권리, 의무 및 책임사항을 규정하여 고객 권익을 보호함을 목적으로 합니다.</p>
							</li>
										...
										<ul class="int3">
											...
											<li>2. <font color="#000000"><span lang="EN-US"
														...
														style="font-size: 9pt; font-family: &amp; amp; amp; amp; amp; amp; amp; amp; amp; quot; 맑은 고딕&amp;amp; amp; amp; amp; amp; amp; amp; amp; quot;; line-height: 107%; mso-bidi-font-family: &amp;amp; amp; amp; amp; amp; amp; amp; amp; quot; Times New Roman&amp;amp; amp; amp; amp; amp; amp; amp; amp; quot;; mso-bidi-theme-font: minor-bidi; mso-ansi-language: EN-US; mso-fareast-language: KO; mso-bidi-language: AR-SA; mso-ascii-theme-font: major-latin; mso-fareast-theme-font: major-latin; mso-hansi-theme-font: major-latin">전환회원<span
															...
															H.Point </span>멤버십에 가입된 고객으로 “현대백화점 인터넷면세점”<span
															lang="EN-US">
															(</span>국문몰에 한함<span lang="EN-US">)</span>에 신규가입 후 통합회원으로
														전환한
														고객으로서<span lang="EN-US"> H.Point </span>멤버십<span lang="EN-US">,
														</span>“현대백화점 인터넷면세점”<span lang="EN-US">,
					...
					<input type="hidden" name="mbshJoinTcndCds" value="002"> <input type="hidden"
						name="mbshJoinTcndVerNos" value="1.7"> <input type="hidden" name="joinNtnlCds" value="KR">
					<p class="step_agree">
						<span class="checkbox round"> <input type="checkbox" name="agrYns" id="agree2" value="Y"> <label
								for="agree2" value="개인정보동의"> 개인정보동의<span> (필수)</span>
							</label>
						</span>
					</p>
					<div class="step_agree_box">
