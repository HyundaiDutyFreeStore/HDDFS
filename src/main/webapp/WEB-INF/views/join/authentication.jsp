				...
				<div class="join_row blocks type2">
					<div class="join_form clearfix">
						...
						<div class="join_col w06">
							<input type="text" id="email_fir" name="email_fir" value=""
								placeholder="이메일" maxlength="30">
						</div>

						<div class="join_col w14 select">
							<select name="email_sec" class="sel_type" id="email_sec"
								style="display: none;">
						...
						<div class="join_col join_btn">
							<button type="button" class="mail_check_button" id="btnSend">인증번호
								발송</button>
						</div>
					</div>
				</div>
