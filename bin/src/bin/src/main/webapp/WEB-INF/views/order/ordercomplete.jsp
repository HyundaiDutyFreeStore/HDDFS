...
<div class="container">
	...
	<div class="text-center p-4">
		<p>주문이 완료되었습니다.</p>
		<p>
			<small>주문번호: 2109984984 (주문일시: 2021.10.01 11:11)</small>
		</p>
		<p>
			<small>배송포장: 쇼핑백 선택</small>
		</p>
	</div>
	<table class="table">
		<thead>
						...
						<div class="row no-gutters">
							<div class="col-md-4">
								<img class="img-thumbnail"
									src="http://newmedia.thehandsome.com/CM/2B/SS/CM2B3ASZ886CS_GN_S01.jpg"
									alt="...">
							</div>
							<div class="col-md-8">
								<div class="card-body p-1 ml-2">
									<p class="card-text">the CASHMERE</p>
									<p class="card-title font-weight-bolder">[KONGES SLOJD] 헨리넥
										셔츠</p>
									<p class="card-text">
										<small class="text-muted">color : BROWN / size : 130</small>
									</p>
								</div>
							</div>
						</div>
