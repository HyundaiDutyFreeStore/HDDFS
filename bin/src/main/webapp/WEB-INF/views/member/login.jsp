			...
			<div class="border_box1">
				<div class="inner_box">
							...
							<fieldset>
								...
								<div class="login_section">
									...
									<div>
										<div> 
											<input class="id_input" name="mid" type="text"
												id="mid" placeholder="아이디 입력하세요." title="아이디"
												value="" style="width: 410px; height: 35px; ">
										</div>
										<div>
											<input class="pw_iput" name="mpassword" type="password"
												id="j_password" placeholder="비밀번호를 입력하세요." title="비밀번호" onkeyup="f_enterLogin()" style="width: 410px; height: 35px; margin-top: 5px;">
										</div>
									</div>
									<c:if test="${result == 0 }">
									...
									<div class="login_button_wrap" style="width: 410px; height: 35px; padding-top: 25px;">
										<input type="button" class="login_button btn add_ss join" href="javascript:f_loginCheck();" value="로그인" style="width: 410px; height: 35px; ">
									</div>
									<div class="logSave">
					...
					<div class="section_bottom">
						<p>
							<span class="bul_sty01" style="margin-bottom: 30px;">
								아이디 / 비밀번호를 잊으셨나요?</span> <a
								onclick="showFindID()"
								target="_blank" class="btn add_ss">아이디 찾기</a> <a
