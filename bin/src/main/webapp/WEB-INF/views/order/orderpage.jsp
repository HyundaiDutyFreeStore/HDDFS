...
<div id="bodyWrap">
    ...
    <form id="orderForm" action="/order/ordercomplete" method="post">
        ...
        <input id="mode" name ="opayment" type="hidden" value=""/>
                                        ...
                                        <div class="coupon_select_wrap" style="margin-top:15px">
                                            ...
                                            <select title="쿠폰을 선택해 주세요." id="selectVoucher" style="width: 190px;">
                                                ...
                                                <c:forEach items="${couponList}" var="coupon">
                                                    <option value="<c:out value="${coupon.cname}"></c:out>"><c:out value="${coupon.cname}"></c:out></option>
                                                </c:forEach>
                                            </select>
                                        ...
                                        <ul>
                                            <li>
                                                <input type="radio" name="mode" id="sel_rd0" checked="checked"
                                                       value="원클릭결제" onclick="changeRadioButton()" >
                                                <label for="sel_rd0" class="mr20 one_click_pay">원클릭결제</label>
                                            </li>
                                            <li>
                                                <input type="radio" name="mode" id="sel_rd1" value="신용카드">
                                                <label for="sel_rd1" class="mr20" onclick="changeRadioButton()">신용카드</label>
                                            </li>
                                            <li>
                                                <input type="radio" name="mode" id="sel_rd2" value="계좌이체"
                                                       onclick="changeRadioButton()">
                                                <label for="sel_rd2" class="mr20">실시간 계좌이체</label>
                                            </li>
                                            <%-- INFO :: 카카오 페이 추가하기--%>
                                            <li>
                                                <input type="radio" name="mode" id="sel_rd3" value="카카오페이"
                                                       onclick="changeRadioButton()">
...
<%--							<a href="#;" class="btn gray " onclick=location.href="/order/ordercomplete?mid=${mid}&ozipcode=?&oaddress1=?&oaddress2=?&oreceiver=?&otel=?&ousedpoint=?&opayment=?&ostatus=?&odiscounted=?&pid=?&ccolorcode=?&ssize=?&oamount=?">결제하기</a>--%>
                    							<a href="#;" type="submit" class="btn gray" onclick="return chk_form()">결제하기</a>
    ...
    function salePrice() {
        ...
        if (pprice < elimit) {
            ...
            if (ccname === "") {
                ...
                document.getElementById("couponDiscounts").innerText = "-\\" + calculatePrice;
