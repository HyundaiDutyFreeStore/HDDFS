...
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/font_80.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/common.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/layout.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/popup.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/jquery-ui.min.css" media="all">

<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/brand.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/footer.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/contents.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/selectshop.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/swiper.min.css" media="all">
<link rel="stylesheet" type="text/css"
	href="${path}/resources/css/products.css" media="all">
<style type="text/css" media="print">
@IMPORT url("${path}/resources/css/print.css");
</style>
...
<script type="text/javascript">
	...
	//재고정보 가져오는 ajax호출
	$.ajax({
		url : "/product/productStock?pid=" + "${productInfo.pid}"
				+ "&ccolorcode=" + "${productInfo.ccolorcode}",
		type : "GET",
		dataType : "json",
		async : false,
		error : function(request, status, error) {
				...
				<div class="clearfix image_view3">
					...
					<div class="image_view1" id="image_view1">
						<div class="item_visual" id="imageDiv" style="margin-top: 20px;">
							<ul>
								<li><img src="${productInfo.cimage1 }" class="respon_image"
									id="img1" alt="${productInfo.pname }"
									onerror="this.src='http://cdn.thehandsome.com/_ui/desktop/common/images/products/no_img1.jpg'" /></li>
								<li><img src="${productInfo.cimage2 }" class="respon_image"
									id="img2" alt="${productInfo.pname }"
									onerror="this.src='http://cdn.thehandsome.com/_ui/desktop/common/images/products/no_img1.jpg'" /></li>
								<li><img src="${productInfo.cimage3 }" class="respon_image"
									id="img3" alt="${productInfo.pname }"
									onerror="this.src='http://cdn.thehandsome.com/_ui/desktop/common/images/products/no_img1.jpg'" /></li>
							</ul>
						</div>
					</div>
					...
					<div class="info">
						<div class="info_sect">
							<h4 class="item_name">
								...
								<span class="name ko_fir_spel"> ${productInfo.pname }<input
									type="hidden" id="brandName" value="LÄTT" /> <input
									type="hidden" id="productName" value="${productInfo.pname }" />
									<input type="hidden" id="productCode"
									value="${productInfo.pid }" />
								</span>
							</h4>
							...
							<p class="price">
								<span>₩<fmt:formatNumber value="${productInfo.pprice}"
										type="number" pattern="###,###" /></span> <input type="hidden"
									id="productPrice" value="${productInfo.pprice}" />
							</p>
							<!-- 상품추가설명 -->
						...
						<div class="info_sect">
							<ul class="point_delivery">
								<%-- <li><span class="title">한섬마일리지</span> <span class="txt"><fmt:formatNumber
											value="${productInfo.pprice * 0.05 }" type="number"
											pattern="###,###" />&nbsp;M&nbsp;(5%)</span></li> --%>
								<li><span class="title">H.Point</span> <span class="txt"><fmt:formatNumber
											value="${productInfo.pprice * 0.001 }" type="number"
								...
								<li><span class="title">사이즈</span> <span class="txt">
										...
										<ul class="size_chip clearfix sizeChipKo1901">
											<c:forEach var="stock" items="${stock}">
												...
												<li><a href="#;">${stock.ssize}</a></li>
											</c:forEach>
										</ul> <%-- <ul class="size_chip clearfix sizeChipKo1901">
											<li>
												<a href="#;">55</a>
											</li>
											<li id="${productInfo.pid}_FREE">
						...
						<div class="total_price clearfix">
							...
							<div class="pirce float_right">
								...
								<span id="sumPrice">₩<fmt:formatNumber
										value="${productInfo.pprice }" type="number" pattern="###,###" /></span>
							</div>
						</div>
						<!-- st_receipt_wrap -->
						...
						<div class="btnwrap clearfix"
							...
							<form id="addToCartForm" name="addToCartForm"
								...
								<input type="hidden" maxlength="3" size="1" name="qty"
									...
									value="IL2C5WSH942W_DN" /> <input type="hidden" id="pid"
									name="pid" value="${productInfo.pid }" /> <input type="hidden"
									id="mid" name="mid" value="${sessionScope.member.mid }" /> <input
									type="hidden" id="psize" name="psize" value="F" /> <input
									type="hidden" id="pamount" name="pamount" value="1" /> <input
