...
<head>
    ...
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/jquery.vticker.js"></script>
    ...
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/netfunnel.js"></script>
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/netfunnel_skin.js"></script>
    ...
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/wisenut/ark/js/ark.js"></script>
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/wisenut/ark/js/beta.fix.js"></script>
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/wisenut/js/jquery.min.js"></script>
    <script type="text/javascript" src="../../../resources/_ui/desktop/common/js/wisenut/js/search.js"></script>
            ...
            <div class="top_nav_wrap clearfix">
                ...
                <div class="util_menu" style="display: block;">
                    <ul class="clearfix">
                        ...
                        <c:if test="${member != null }">
                            <c:if test="${member.menabled == 2 }">
                                <li><a href="/admin/main">관리자 페이지</a></li>
                            </c:if>
                            <li><a id="gnb_logout_button" href="/">로그아웃</a></li>
                        </c:if>
                        ...
                        <li class="header_dropmemu mypage"><a href="/event/eventlist"
                                                              class="btn">이벤트</a>
        ...
        <div class="gnbwarp com clearfix">
                        ...
                        <div class="sub_back" style="height: 0px; border-bottom: 0px;">
                            <div class="sub_menu clearfix" style="display: none;">
                                <ul class="al_frt1 sm_dep1"
                                    ...
                                    <li><!-- <a href="/list?clarge=여성&cmedium=&csmall=">전체보기전체보기</a> -->
                                    </li>
                                    <li><!-- <a href="/list?clarge=여성&cmedium=아우터&csmall=">아우터</a> -->
                                        <ul class="clearfix sm_dep2">
                                            <li><a href="/listBrand?bname=3.1 Phillip Lim">3.1 Phillip Lim</a>
                                            </li>
                                            <li><a href="/listBrand?bname=BALLY">BALLY</a>
                                            </li>
                                            <li><a
                                                    href="/listBrand?bname=CLUB MONACO">CLUB MONACO</a>
                                            </li>
                                            <li><a href="/listBrand?bname=FOURM MEN'S LOUNGE">FOURM MEN'S LOUNGE</a></li>
                                            <li><a href="/listBrand?bname=FOURM STUDIO">FOURM STUDIO</a>
                                            </li>
                                            <li><a href="/listBrand?bname=FOURM THE STORE">FOURM THE STORE</a>
                                            </li>
                                            <li><a href="/listBrand?bname=ROCHAS">ROCHAS</a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li><!-- <a href="/list?clarge=여성&cmedium=탑&csmall=">탑</a> -->
                                        <ul class="clearfix sm_dep2">
                                            ...
                                            <li><a href="/listBrand?bname=LANVIN COLLECTION">LANVIN COLLECTION</a>
                                            </li>
                                            <li><a href="/listBrand?bname=LANVIN PARIS">LANVIN PARIS</a>
                                            </li>
                                            <li><a href="/listBrand?bname=MINE">MINE</a>
                                            </li>
                                    ...
                                    <li><!-- <a href="/list?clarge=여성&cmedium=드레스&csmall=">드레스</a> -->
                                        <ul class="clearfix sm_dep2">
                                            ...
                                            <li><a href="/listBrand?bname=SYSTEM HOMME">SYSTEM HOMME</a></li>
                                            <li><a href="/listBrand?bname=the CASHMERE">the CASHMERE</a></li>
                                            <li><a href="/listBrand?bname=TIME">TIME</a></li>
                                            <li><a href="/listBrand?bname=TIME HOMME">TIME HOMME</a></li>
                                            <li><a href="/listBrand?bname=TOM GREYHOUND">TOM GREYHOUND</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="util_menu util_menu1803">
                <ul class="clearfix">
                    ...
                    <li><a href="/cart/cartList"> <span class="ico cart">장바구니</span>
                        <span class="count"> (<span id="cartCount">${sessionScope.cartTotal}</span>)
							</span>
                    </a></li>
                </ul>
            </div>
