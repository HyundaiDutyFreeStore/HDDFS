...
<!-- 김가희 김나형 - 자바스크립트에서 금액 단위 잘라서 표시하는 함수 -->
<script>
//숫자 format
                    ...
                    <div id="checkoutCartView" class="tblwrap">
                        <table class="tbl_ltype ">
                            ...
                            <tr class="al_middle">
                                ...
                                <!-- 수량  -->
                                <td>${orderinfo.pamount}</td>
                                <td>
                                    <!-- price_wrap -->
                                    <div id="price_wrap" class="price_wrap ">
                                        <span id="price" style="display: block"><fmt:formatNumber value="${orderinfo.pprice}"
                                                                                                  pattern="\###,###,###,###"/></span>
                                    ...
                                    <div id="price_wrap coupon" class="price_wrap coupon" style=" display : none">
                                        <span id="saleprice"><fmt:formatNumber value="${salePrice}"
                                                                               pattern="\###,###,###,###"/></span>
                                    </div> <!-- //price_wrap -->
                                </td>
                            </tr>
                    ...
                    <div class="tblwrap">
                        <table class="tbl_wtype1">
                            ...
                            <tr>
                                ...
                                <td>${orderList.get(0).mname}</td>
                            </tr>
                            <tr>
                                <th scope="row" class="th_space">휴대폰</th>
                                <td>
                                    ${orderList.get(0).mtel}</td>
                            </tr>
                            <tr>
                                <th scope="row" class="th_space">E-mail</th>
                                <td>${orderList.get(0).memail}</td>
                            </tr>
                    ...
                    <div class="tblwrap" id="deliveryInfoTitle">
                        <table class="tbl_wtype1">
                            ...
                            <tr>
                                ...
                                <td><!-- address -->
                                    <input value="" title="우편번호" id="address" name="postcode" class="post" type="text"
                                           readonly="">
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- phone --> <select name="ph_num1" id="ph" title="연락처 앞자리" class="hp_num1">
                                        ...
                                        <div class="vvip_td_wrap" id="select_voucher">
                                            <div class="coupon_select_wrap" style="margin-top:15px">
                                                ...
                                                <select title="쿠폰을 선택해 주세요." id="selectVoucher" style="width: 190px;">
                                                    ...
                                                    <option value="${coupon.cname}">
                                                        <c:out value="${coupon.cname}"></c:out>
                                                    </option>
                                                    </c:forEach>
                                                </select>
                                                ...
                                                <script>
                                                    function salePrice() {
                                                        ...
                                                        var pprice = ${orderTotal};
                                                        /* var elimit = ${orderinfo.elimit}; */
                                                        var minusPrice = pprice * 0.1;
                                                        console.log(ccname);
                                                        /* if (pprice < elimit) {
                                                            ...
                                                            if (ccname === "") {
                                                                ...
                                                                document.getElementById("couponDiscounts").innerText = "-\\" + minusPrice;
                                                                var total = parseInt($('#totalPrice').val()) - parseInt(pprice*0.1);
                                                    ...
                                                    function cancelSalePrice() {
                                                        ...
                                                        document.getElementById("totalPrice").value = parseInt($('#totalPrice').val()) + parseInt(${minusPrice});
                                                    }
                                                </script>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="point_wrap">
                                        <input title="H.Point 결제" class="inpput" type="text" id="hpointpay"
                                               name="useHPoint" numberonly="true" onchange="printPoint()">

                                        <p class="p_txt">
                                            P 사용 (잔액 : <span>${mPoint}P</span>)
                                        </p>
                                        <!-- apply -->
                                        ...
                                        <script>
                                            var hpoint = document.getElementById("hpointpay").value;

                                            function printPoint() {
                                                hpoint = document.getElementById("hpointpay").value;
                                            }

                                            function doUseHPoint() {
                                                console.log(hpoint)
                                                if (hpoint === "" || hpoint >'${mPoint}') {
                                                    ...
                                                    document.getElementById("hpointDiscount").innerText = "-\\" + hpoint;
                                                    console.log('포인트사용전'+$('#totalPrice').val());
                                                    var total = parseInt($('#totalPrice').val()) - parseInt(hpoint);
                                                    
                                                   // $('#totalPrice').val(parseInt($('#totalPrice').val()) - parseInt(hpoint));
													$('#totalPrice').val('₩ '+total.format());
                                                }
                                            }
                                        ...
                                        <ul>
                                            <li>
                                                <input type="radio" name="mode" id="sel_rd0" checked="checked"
                                                       value="KO001-3" onclick="showCkout(this);">
                    ...
                    <div class="sum_box">
                        <div>
                            ...
                            <dl class="clearfix">
                                ...
                                <dd class="sub_total190816" id="subTotal"><fmt:formatNumber value="${orderTotal}"
                                                                                            pattern="\###,###,###,###"/></dd>
                                <dt>프로모션/쿠폰 할인 금액</dt>
                        ...
                        <div class="total">
                            <dl class="clearfix">
                                ...
                                <dd>
                                    <input id="totalPrice" value=${orderTotal} readonly size=10
                    ...
                    <div class="p_a_box">
                        <div class="point">
                            ...
                            <p class="txt" id="txtAccumulationHPoint">H.Point
                                <fmt:formatNumber value="${addPoint}"
                                                  pattern="###,###,###,###P"/>
                            </p>
                        </div>
