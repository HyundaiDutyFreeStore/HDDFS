		...
		<div class="lnb_wrap">
			...
			<div class="lnb">
				...
				<dl>
					...
					<dd><a href="/ko/mypage/mymantomaninquiry" onclick="GA_Event('마이페이지','LNB','1:1 문의');">1:1 문의</a>
					</dd>
					...
					<ul>
						<li>
							...
							<div class="calendar_wrap mr5">
								<!-- readonly -->
								<input type="text" class="input_date hasDatepicker" title="기간 입력" id="sterm"
									name="sterm" value="" readonly=""><button type="button"
									class="ui-datepicker-trigger ico_cld">...</button>
								<div class="form_hyphen pl5">-</div>
								<input type="text" class="input_date hasDatepicker" title="기간 입력" id="eterm"
									name="eterm" value="" readonly=""><button type="button"
									class="ui-datepicker-trigger ico_cld">...</button>
							</div>
							<div class="tab_c">
								<ul class="clearfix">
				...
				<table class="tbl_ltype">
					...
					<tbody id="listBody">
						<c:forEach items="${list}" var="list" varStatus="status">
							<tr class="al_middle" id="clickme1" cdlist="[]" pk="8934868406202" onclick="show1('${list.qid}', '${list.mid}', '${list.qreply}')">
								<td class="frt">
									<fmt:formatDate value="${list.qdate}" pattern="yyyy-MM-dd" />
								</td>
								<td class="al_left"><a class="move" href='${list.qid}'>
										${list.qcategory}
									</a></td>
								<td>
									${list.qtitle}
							...
							<tr class="info3" style="display:none" id="hideme${list.qid}">
								<td class="qna_wrap" colspan="5">
									<div class="qna_box ch">
										<p></p>
										<div class="qt"><span class="ico">quest</span>
											<div class="txt">
												<p style="word-wrap:break-word">${list.qcontent}</p>
											</div>
										</div>
										<div class="an">
											<span class="ico"></span>
											<div class="txt">
											${list.qreply}
											<form id="addReply" action="/qna/qnaReplyAdd" name="formm" method="post" enctype="multipart/form-data">
											<div class="reply">
												<input type="hidden" name="qid" value="${list.qid}"/>
												<%-- <input type="text" name="qreply" id="adminAnswer${list.qid}" style="display:none;"/> --%>
													<textarea name="qreply" id="adminAnswer${list.qid}" style="display:none; width:98%; vertical-align: middle; resize: none; padding: 2px" cols rows="4"></textarea>
													<div style="margin:5px 0 0 2px;">
														<input type="submit" id="adminAnswerBtn${list.qid}" value="답변달기" onclick="addReply('${list.qid}')" style="display:none; width:98%; padding:5px 0;"/>
													</div>
											</div>
											</form>
												<div class="btnwrap mt40" id="myDIV${list.qid}" style="display:none; text-align:right;" > 
...
<!-- 						<tr class="al_middle" id="clickme1" cdlist="[]" pk="8934868406202" onclick="show1(1,this)">
							<td class="frt">2022.10.21</td>
							<td>쿠폰/혜택문의</td>
							<td class="al_left"><a href="javascript:void(0);">test</a></td>
							<td>[접수완료]</td>
						</tr>
						<tr class="info3" style="display:none" id="hideme1">
							<td class="qna_wrap" colspan="4">
								<div class="qna_box ch">
									...
									<div class="an"><span class="ico">answer</span>
										<div class="txt">
											<div class="btnwrap mt40" style="text-align:right"> <a
													href="javascript:fn_manToManInquiryEdit('E','8934868406202');"
													id="qnaWriteSend">수정</a> <a
													href="javascript:fn_manToManInquiryEdit('D','8934868406202');"
													id="qnaCancle">삭제</a></div>
											<p class="date"></p>
										</div>
									</div>
								</div>
